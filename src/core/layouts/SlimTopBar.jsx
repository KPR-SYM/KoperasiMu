                            ...
                            {profileOpen && (
                                <div className={`absolute mt-2 w-52 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-xl overflow-hidden z-50
                                    ...
                                    <button
                                        ...
                                        type="button"
                                    >
                                        <GearSix className="w-4 h-4 shrink-0" strokeWidth={2} /> <span>{t("nav.settings")}</span>
                                    </button>
                                    <button
                                        ...
                                        type="button"
                                    >
                                        <SignOut className="w-4 h-4 text-red-600 shrink-0" strokeWidth={2} /> <span>{t("ui.logout")}</span>
                                    </button>
                                </div>
                            )}
                        </div>
