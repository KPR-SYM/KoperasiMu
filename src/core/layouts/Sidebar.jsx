...
function SidebarGroup({ group, items, collapsed, isOpen, onToggle }) {
    ...
    return (
        <div className="relative group/grp flex flex-col">
            ...
            >
                {/* Left Side: UsersThree Icon (when collapsed) OR UsersThree Label (when expanded/hovered) */}
                <div className="flex items-center min-w-0">
                    {/* UsersThree Icon — only visible when collapsed (hidden on hover sidebar) */}
                    ...
                    {/* UsersThree Label — hidden when collapsed, shown when expanded or sidebar hover */}
                ...
                >
                    <NavIcon
                        ...
                        className="w-2 h-2 shrink-0 text-[var(--color-text-muted)]/70"
                    />
                </div>
            </button>
...
export default function Sidebar({ collapsed, onToggle }) {
    ...
    // FloppyDisk scroll position on user scrolling
