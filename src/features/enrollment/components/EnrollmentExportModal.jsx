...
const COLUMN_DEFS = [
    ...
    { key: 'no_reg', label: 'No. Registrasi', icon: Barcode },
    { key: 'nama', label: 'Nama', icon: User },
    { key: 'gender', label: 'Gender', icon: GenderIntersex },
    { key: 'nisn', label: 'NISN', icon: IdentificationCard },
    { key: 'asal_sekolah', label: 'Asal Sekolah', icon: Buildings },
    { key: 'program', label: 'Program', icon: Star },
    { key: 'gelombang', label: 'Gelombang', icon: WavesLadder },
    ...
    { key: 'uniform_size', label: 'Seragam', icon: TShirt },
