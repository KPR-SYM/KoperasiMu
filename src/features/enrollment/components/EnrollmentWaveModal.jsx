            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                    {waves.map(wave => {
                        ...
                        if (isEditingThis) {
                            // Render Form Pen Inline langsung di posisi kartu gelombang ini!
                            return (
                                <div
                                    key={wave.id}
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div className="sm:col-span-2 p-3.5 border border-dashed border-[var(--color-border)] rounded-2xl bg-[var(--color-surface-alt)]/30 space-y-3">
                                            <span className="text-[9px] font-black uppercase tracking-widest text-[var(--color-text-muted)] flex items-center gap-1.5">
                                                <Money className="opacity-60 w-3 h-3" />
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                                <div className="relative group">
                                                    ...
                                                    <div className="relative">
                                                        <span className="absolute left-3.5 top-1/2 -translate-y-1/2 w-3 h-3 font-bold text-[var(--color-text-muted)] opacity-50">Rp</span>
                                                        <input
                                                            type="number"
                            ...
                            >
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex items-center gap-3.5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5 font-medium">
                                                Tahun Pelajaran {wave.academic_year} Â· Kuota: <span className="font-bold text-[var(--color-text)]">{wave.quota ? `${wave.quota} santri` : 'Tanpa Batas'}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-1">
                                        ...
                                        >
                                            {wave.is_active ? <ToggleRight className="text-xl" /> : <ToggleLeft className="text-xl" />}
                                        </button>
                                    </div>
                                </div>
            ...
            <Modal
                ...
                footer={
                    <div className="flex items-center w-full gap-3">
                        ...
                        >
                            {submitting ? (
                                <Spinner className="fa-spin w-3 h-3" />
                            ) : (
