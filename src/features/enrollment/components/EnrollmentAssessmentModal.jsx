        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-1">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2 pb-1 border-b border-[var(--color-border)]/50">
                        <Book className="text-emerald-500 w-3 h-3 opacity-75" />
                    ...
                    {!form.test_score && (
                        <div className="bg-amber-500/10 border border-amber-500/20 text-amber-600 px-3 py-2.5 rounded-xl w-3 h-3 flex items-start gap-2">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2 pb-1 border-b border-[var(--color-border)]/50">
                        <Star className="text-indigo-500 w-3 h-3 opacity-75" />
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="flex items-center gap-2 px-3 h-10 border border-[var(--color-border)] rounded-xl bg-[var(--color-surface)] focus-within:border-[var(--color-primary)] transition-all">
                            <User className="w-3 h-3 text-[var(--color-text-muted)] opacity-40 shrink-0" />
                            <input
                                type="text"
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="flex items-start gap-2 p-3 border border-[var(--color-border)] rounded-xl bg-[var(--color-surface)] focus-within:border-[var(--color-primary)] transition-all">
                            <ChatCircle className="w-3 h-3 text-[var(--color-text-muted)] opacity-40 shrink-0 mt-0.5" />
                            <textarea
            ...
            <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-[var(--color-border)]">
                ...
                >
                    {submitting ? (
                        <>
                            <FloppyDisk className="fa-spin" />
                            <span>Menyimpan...</span>
                        </>
                    ) : (
                        <>
                            <FloppyDisk className="opacity-80 shrink-0" />
