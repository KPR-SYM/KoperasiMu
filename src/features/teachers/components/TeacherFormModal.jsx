...
const TeacherFormModal = memo(function TeacherFormModal({
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title={selectedItem ? `Pen Data ${form.type === 'karyawan' ? 'Karyawan' : 'Guru'}` : `Tambah ${form.type === 'karyawan' ? 'Karyawan' : 'Guru'} Baru`}
            description={
            ...
            <form id="teacher-form-modal" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2.5 pt-2">
                        ...
                        <SealCheck className="text-indigo-500 w-3 h-3 opacity-70" />
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2.5 pt-2">
                        ...
                        <Envelope className="text-amber-500 w-3 h-3 opacity-70" />
                ...
                <div className="space-y-4 pb-4">
                    <div className="flex items-center gap-2.5 pt-2">
                        ...
                        <Fingerprint className="text-slate-500 w-3 h-3 opacity-70" />
                ...
                {formError && (
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-red-500/10 border border-red-500/20 animate-in fade-in">
                        ...
                        <p className="w-3 h-3 font-bold text-red-600">{formError}</p>
                    </div>
                )}
            </form>
        </Modal>
