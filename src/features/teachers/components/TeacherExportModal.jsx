...
import { Warning, ArrowDown, ArrowsLeftRight, ArrowsDownUp, Barcode, Book, BookOpenText, Suitcase, Calendar, CalendarCheck, CheckCircle, CaretDown, Question, Clock, FileXls, FileText, FileArrowUp, GraduationCap, Hash, TextH, IdentificationCard, List, Spinner, Envelope, MapPin, ChatCircle, ChartPie, GearSix, SlidersHorizontal, Star, Tag, User, Users, GenderIntersex } from '@phosphor-icons/react'
...
const COLUMN_DEFS = [
    ...
    { key: 'employment_status', label: 'Status Kepegawaian', icon: Suitcase },
    { key: 'teaching_hours', label: 'Jam Mengajar', icon: Clock },
    { key: 'last_education', label: 'Pendidikan Terakhir', icon: GraduationCap },
    { key: 'major', label: 'Jurusan', icon: BookOpenText },
    { key: 'graduation_year', label: 'Tahun Lulus', icon: CalendarCheck },
