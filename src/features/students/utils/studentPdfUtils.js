...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  <hr class="div">
  <div class="ftr">Diterbitkan: ${dateStr}<br>Koperasi SenyumMu &bull; MBS Tanggul</div>
</body></html>`;
...
export const generateStudentPDF = async (targets, captureRef = null, { addToast, setGeneratingPdf }) => {
    ...
    try {
        ...
        for (let i = 0; i < targets.length; i++) {
            ...
            doc.text('Admin Koperasi SenyumMu', pageWidth - margin - 55, signY + 22);
            ...
            doc.text('* Dokumen ini diterbitkan secara digital oleh sistem Koperasi SenyumMu.', margin, signY + 5);
            ...
            doc.text('Dokumen Digital Otomatis · MBS Tanggul · Koperasi SenyumMu', pageWidth / 2, 287, { align: 'center' });
        }
