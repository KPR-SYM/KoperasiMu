...
import { Warning, ArrowDown, ArrowsLeftRight, ArrowsDownUp, Barcode, Calendar, CheckCircle, CaretDown, Question, FileXls, FileText, FileArrowUp, HandHeart, Hash, TextH, House, IdentificationCard, List, Spinner, MapPin, GenderMale, ChatCircle, ChartPie, Buildings, GearSix, Shield, SlidersHorizontal, Star, Tag, User, Users, GenderFemale, GenderIntersex } from '@phosphor-icons/react'
...
const COLUMN_DEFS = [
    ...
    { key: 'gender', label: 'Gender', icon: GenderIntersex },
    { key: 'kelas', label: 'Kelas', icon: Buildings },
    { key: 'birth_place', label: 'Tempat Lahir', icon: MapPin },
    { key: 'birth_date', label: 'Tgl Lahir', icon: Calendar },
    { key: 'religion', label: 'Agama', icon: HandHeart },
    { key: 'address', label: 'Alamat', icon: House },
    ...
    { key: 'kelengkapan', label: 'Data', icon: ChartPie },
]
                ...
                <div className={`space-y-6 pb-2 transition-all duration-500 ${exporting ? 'blur-sm grayscale-[0.5] opacity-50 pointer-events-none' : ''}`}>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-3 gap-2.5">
                            {[
                                { val: 'filtered', label: 'Funnel Aktif', desc: `${students.length} siswa`, icon: SlidersHorizontal },
                                { val: 'selected', label: 'Dipilih', desc: `${selectedStudentIds.length} siswa`, icon: CheckCircle, disabled: selectedStudentIds.length === 0 },
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                            {[
                                ...
                                {
                                    label: 'PDF Kartu', icon: IdentificationCard, desc: 'Cetak Kartu',
                                    onClick: async () => {
                                        let targets = []
