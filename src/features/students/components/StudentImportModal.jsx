...
import { WarningCircle, Warning, ArrowLeft, ArrowsLeftRight, ArrowRight, Check, CheckCircle, CaretDown, CaretUp, Copy, DownloadSimple, FileArrowDown, FileText, SlidersHorizontal, List, Spinner, Pen, Buildings, Tag, Trash, UploadSimple, Lightning } from '@phosphor-icons/react'
                                ...
                                <div className="max-h-[160px] overflow-auto py-1 scrollbar-none">
                                    {filteredClasses.length > 0 ? filteredClasses.map(c => (
                                        ...
                                        >
                                            ...
                                            {value === c.id && <Check className="w-2 h-2" />}
                                        </button>
                                    )) : (
        ...
        >
            ...
            {importStep === 1 && (
                <div className="space-y-2.5">
                    ...
                    {/* --- Reference & Guidance Rows (Compact & Zero-Scroll) --- */}
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="relative" ref={classesDropdownRef}>
                                    ...
                                    >
                                        ...
                                        <CaretDown className={`w-2 h-2 transition-transform duration-300 ${showClassesDropdown ? 'rotate-180' : ''}`} />
                                    </button>
                ...
                <div className="space-y-4">
                    {importLoading ? (
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Bulk Fix Rows - Smart Suggestion */}
