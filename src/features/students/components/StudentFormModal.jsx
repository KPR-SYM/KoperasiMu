...
import { Warning, ArrowLeft, ArrowRight, SealCheck, Book, Calendar, Camera, CheckCircle, CaretDown, Coins, DoorOpen, Eye, FileText, GraduationCap, HandHeart, Heart, ClockCounterClockwise, House, IdentificationCard, Info, Buildings, ListChecks, Spinner, MapTrifold, MapPin, GenderMale, ChatCircle, Pen, Pencil, PersonSimple, Phone, Plus, FloppyDisk, Suitcase, Trash, Lightning, GenderFemale, User, Users } from '@phosphor-icons/react'
...
import {
    ...
    LIVING_WITH,
    TRANSPORT_MODES
} from '@features/students/utils/studentsConstants'
...
const StudentFormModal = memo(function StudentFormModal({
    ...
    // FloppyDisk Draft (Debounced 500ms to eliminate synchronous I/O blocking during fast typing)
    useEffect(() => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!form.name.trim() || !form.class_id) {
            // Crosshair first error (simplified)
            return
        }
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title={selectedStudent ? 'Pen Data Siswa' : 'Tambah Siswa Baru'}
            description={
                ...
                <div className="flex flex-col w-full gap-3">
                    ...
                    <div className="flex items-center w-full gap-3">
                        ...
                        {currentStep === 1 && !isQuickMode && form.name && form.class_id && (
                            ...
                            >
                                <Lightning className="opacity-70 group-hover:animate-pulse" />
            ...
            >
                ...
                <div className="flex flex-col gap-3">
                    {hasDraft && (
                        <div className="flex items-center justify-between p-2 rounded-xl bg-amber-500/10 border border-amber-500/20 animate-in slide-in-from-top-2">
                            <div className="flex items-center gap-2">
                                <ClockCounterClockwise className="text-amber-500 w-3 h-3" />
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1.5">
                            {[1, 2, 3].map(step => (
                                <React.Fragment key={step}>
                                    ...
                                    >
                                        {step < currentStep ? <CheckCircle className="w-3 h-3" /> : <span className="text-[10px] font-black">{step}</span>}
                        ...
                        >
                            <Lightning className={`w-3 h-3 ${isQuickMode ? 'animate-pulse' : 'opacity-40'}`} />
                ...
                {(currentStep === 1 || isQuickMode) && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="relative">
                                            ...
                                            />
                                            <SealCheck className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-3 h-3 transition-colors ${getStatus('nis') === 'success' ? 'text-emerald-500' : 'text-[var(--color-text-muted)] opacity-50 group-focus-within:text-[var(--color-primary)]'}`} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="relative group">
                                ...
                                <div className="relative">
                                    ...
                                    />
                                    <IdentificationCard className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--color-text-muted)] opacity-50 w-3 h-3 transition-colors group-focus-within:text-[var(--color-primary)]" />
                                </div>
                            </div>
                            <div className="relative group">
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-9 pr-3 h-11 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none transition-all text-[13px] text-[var(--color-text)] placeholder:text-[var(--color-text-muted)] placeholder:opacity-40"
                                    />
                                    <MapPin className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--color-text-muted)] opacity-50 w-3 h-3 transition-colors group-focus-within:text-[var(--color-primary)]" />
                                </div>
                            </div>
                            <div className="relative group">
                        ...
                        <div className="flex items-center gap-2.5 pt-2">
                            <div className="w-1 h-4 bg-[var(--color-primary)] rounded-full" />
                            <Buildings className="text-[var(--color-primary)] w-3 h-3 opacity-70" />
                ...
                {currentStep === 2 && !isQuickMode && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-indigo-500/[0.03] border border-indigo-500/10">
                            <span className="text-[9px] font-bold text-indigo-600/70 uppercase">Progress Rows</span>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 border border-[var(--color-border)] rounded-2xl bg-[var(--color-surface)] space-y-4">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-2.5 pt-2">
                                        <div className="w-1 h-4 bg-[var(--color-primary)] rounded-full" />
                                        <IdentificationCard className="text-[var(--color-primary)] w-3 h-3 opacity-70" />
                            ...
                            <div className="p-4 border border-[var(--color-border)] rounded-2xl bg-[var(--color-surface)] space-y-4">
                                <div className="flex items-center gap-2.5 pt-2">
                                    <div className="w-1 h-4 bg-[var(--color-primary)] rounded-full" />
                                    <Phone className="text-[var(--color-primary)] w-3 h-3 opacity-70" />
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full pl-9 pr-3 h-11 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none transition-all text-[13px] text-[var(--color-text)] placeholder:text-[var(--color-text-muted)] placeholder:opacity-40"
                                            />
                                            <User className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--color-text-muted)] opacity-50 w-3 h-3" />
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="relative group">
                ...
                {currentStep === 3 && !isQuickMode && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-emerald-500/[0.03] border border-emerald-500/10">
                            <span className="text-[9px] font-bold text-emerald-600/70 uppercase">Progress Rows</span>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 border border-[var(--color-border)] rounded-2xl bg-[var(--color-surface)] space-y-4">
                                <div className="flex items-center gap-2.5 pt-2">
                                    ...
                                    <FileText className="text-amber-500 w-3 h-3 opacity-70" />
                                ...
                                >
                                    <div className="flex items-center gap-3 text-left">
                                        <div className="w-8 h-8 rounded-lg bg-[var(--color-surface-alt)] flex items-center justify-center border border-[var(--color-border)]">
                                            <Pen className="w-3 h-3 text-[var(--color-text-muted)]" />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <CaretDown className={`w-3 h-3 opacity-40 transition-transform duration-300 ${showMetadata ? 'rotate-180' : ''}`} />
                                    </div>
                                </button>
                                ...
                                <div className="space-y-3 relative z-10">
                                    ...
                                    <div className="p-4 rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] shadow-sm">
                                        <div className="flex items-center gap-2 mb-3">
                                            <IdentificationCard className="w-3 h-3 text-indigo-500" />
                                                ...
                                                <div className="flex items-center gap-1.5 mt-0.5">
                                                    {form.gender === 'L' ? (
                                                        <div className="flex items-center gap-1.5 px-1.5 py-0.5 rounded-md bg-indigo-500/10 border border-indigo-500/20">
                                                            <GenderMale className="w-3 h-3 text-indigo-500" />
                                                        ...
                                                        <div className="flex items-center gap-1.5 px-1.5 py-0.5 rounded-md bg-rose-500/10 border border-rose-500/20">
                                                            <GenderFemale className="w-3 h-3 text-rose-500" />
