...
import { CheckCircle, CaretDown, Copy, DownloadSimple, FileText, GraduationCap, ImageSquare, Link, Spinner, ChatCircle, Printer, ArrowCounterClockwise } from '@phosphor-icons/react'
                            ...
                            >
                                ...
                                <div className={`w-[300px] h-[188px] rounded-xl text-white relative shadow-xl overflow-hidden shrink-0 scale-95 sm:scale-100 origin-center transition-all duration-500 hover:scale-[1.02] ring-1 ring-white/20 ${student.gender === 'P' ? 'bg-gradient-to-br from-rose-500 to-rose-700 shadow-rose-500/20' : 'bg-gradient-to-br from-indigo-600 to-indigo-800 shadow-indigo-500/20'}`}>
                                    ...
                                    <div className="absolute top-3 right-3 flex items-center gap-1.5 z-10">
                                        ...
                                        <span className="text-[7px] font-black uppercase tracking-[0.2em] opacity-80 text-white">Koperasi SenyumMu</span>
                                    </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="space-y-0.5">
                                                    <p className="text-[8px] font-black text-white/90 uppercase tracking-tight leading-tight flex items-center gap-1">
                                                        <GraduationCap className="w-2 h-2 opacity-60" />
                                                        {student.className}
                                                    </p>
                    ...
                    {!isBulk && studentsToShow.length > 0 ? (
                        ...
                        <div className="bg-[var(--color-surface-alt)]/40 border border-[var(--color-border)] rounded-[1.5rem] overflow-hidden shadow-2xl shadow-black/5 backdrop-blur-md">
                            <div className="p-4 space-y-4">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
                                    ...
                                    >
                                        <ChatCircle className="w-3 h-3 transition-transform group-hover:rotate-12 shrink-0" />
                                        <span>Bagikan ke Wali</span>
                                    </button>
                                </div>

                                {/* Rows Header: System Management */}
                                ...
                                <div className="flex items-center justify-between gap-3 pt-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        >
                                            {resettingPin ? <Spinner className="animate-spin" /> : <ArrowCounterClockwise className="group-hover:-rotate-180 transition-transform duration-300" />}
                                            Reset PIN
                                        </button>
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            {generatingPdf
                                                ? <><Spinner className="animate-spin" /> Proses...</>
                                                : <><DownloadSimple /> Cetak & Ekspor <CaretDown className={`w-2 h-2 transition-transform duration-300 ${showExportMenu ? 'rotate-180' : ''}`} /></>
                                            }
                                        </button>
                                        {showExportMenu && (
                                            <>
                                                ...
                                                <div className="absolute bottom-full mb-2 right-0 z-20 w-52 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                                                    ...
                                                    <div className="p-1 space-y-0.5">
                                                        ...
                                                        >
                                                            <FileText className="w-4 text-[var(--color-primary)]" />
                                                            Surat Akses PDF
                                                        </button>
                                                        <button
                                                        ...
                                                        >
                                                            <ImageSquare className="w-4 text-emerald-500" />
                                                            Simpan Gambar (PNG)
                                                        </button>
                                                        <button
                                                        ...
                                                        >
                                                            <Printer className="w-4 text-orange-500" />
                                                            Struk Kasir (Thermal)
                                                        </button>
                                                    </div>
                                                </div>
                        ...
                        <div className="flex items-center justify-end w-full gap-3">
                            ...
                            >
                                {generatingPdf
                                    ? <><Spinner className="animate-spin" /> Proses...</>
                                    : <><Printer className="w-3 h-3" /> Cetak Semua ({studentsToShow.length})</>
                                }
                            </button>
                        </div>
                    )}
