    ...
    return (
        <div className="flex flex-col min-h-screen bg-[var(--color-surface)]">
            <div className="px-4 py-3 border-b border-[var(--color-border)] flex items-center gap-3">
                ...
                <h1 className="text-sm font-black uppercase tracking-widest">Export Siswa</h1>
            </div>
            <div className="flex-1 flex items-center justify-center p-6">
                <div className="w-full max-w-md text-center space-y-4">
                    <div className="w-16 h-16 rounded-2xl bg-[var(--color-primary)]/10 flex items-center justify-center mx-auto">
                        <DownloadSimple className="w-8 h-8 text-[var(--color-primary)]" />
                    </div>
                    <h2 className="text-lg font-black uppercase tracking-widest">Export Data</h2>
                    <p className="text-xs text-[var(--color-text-muted)]">Pilih format dan unduh data siswa</p>
                </div>
            </div>
        </div>
    )
