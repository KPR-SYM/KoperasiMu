...
import { ArrowRight, ChartPie, Shield } from '@phosphor-icons/react'
        ...
        <div className="grid lg:grid-cols-2 gap-4">
                ...
                {!loading && raportProgress.length > 0 && (() => {
                    ...
                    return (
                        <div className="mt-4 pt-4 border-t border-[var(--color-border)] flex items-center justify-between">
                            ...
                            <Link to="/raport" className="w-3 h-3 font-black text-[var(--color-primary)] hover:opacity-70 flex items-center gap-1.5 transition-all">
                                Lihat Semua Raport <ArrowRight className="w-2 h-2" />
                            </Link>
                        </div>
                    )
                })()}
            ...
            <div className="glass rounded-[1.5rem] p-5 flex flex-col">
                ...
                <Link to="/master/students"
                    className="mt-4 pt-4 border-t border-[var(--color-border)] w-3 h-3 font-black text-[var(--color-primary)] hover:opacity-70 flex items-center justify-end gap-1.5 transition-all">
                    Lihat Semua Siswa <ArrowRight className="w-2 h-2" />
                </Link>
            </div>
        </div>
    )
