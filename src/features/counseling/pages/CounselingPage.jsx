...
export default function CounselingPage() {
    ...
    // FloppyDisk record to Supabase with local storage fallback
    ...
    // --- Grouping by Date for ClockClockwise View ---
            ...
            <div className="p-4 md:p-6 space-y-5">
                ...
                <PageHeader
                    ...
                    actions={
                        <>
                            ...
                            >
                                <FileXls className="w-4 h-4 text-emerald-500" />
                ...
                <div className="glass p-4 rounded-2xl border border-[var(--color-border)] flex flex-col md:flex-row gap-4 items-center justify-between">
                    ...
                    <div className="relative w-full md:max-w-xs shrink-0">
                        <MagnifyingGlass className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--color-text-muted)] opacity-50" />
                        <input
                            type="text"
                            value={searchQuery}
                ...
                {loading ? (
                    <div className="glass rounded-2xl border border-[var(--color-border)] p-12 text-center">
                        ...
                        <p className="text-[var(--color-text-muted)] text-sm font-bold animate-pulse">Menghubungkan ke layanan database Koperasi SenyumMu...</p>
                    </div>
                    ...
                    <div className="space-y-6 max-w-4xl mx-auto py-2">
                        {timelineGroups.map(([dateString, groupLogs]) => (
                            <div key={dateString} className="relative pl-6 sm:pl-8 space-y-4">
                                ...
                                {/* Absolute ClockClockwise Circle & vertical track line */}
                ...
                {/* --- Modal 1: Add / Pen Session --- */}
                <Modal
                    isOpen={isSessionModalOpen}
                    onClose={() => setIsSessionModalOpen(false)}
                    title={activeLog ? 'Pen Sesi Bimbingan BK' : 'Catat Sesi Bimbingan BK'}
                    icon={HandHeart}
                    size="lg"
                    ...
                    <form onSubmit={handleSaveRecord} className="space-y-4">
                        ...
                        <div className="relative">
                            <div className="flex justify-between items-center mb-1.5">
                                ...
                                >
                                    <Sparkle className={`w-3.5 h-3.5 ${aiLoading ? 'animate-spin' : ''}`} />
