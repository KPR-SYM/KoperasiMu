...
export function useClassesKeyboard({
    ...
    useEffect(() => {
        const handler = e => {
            ...
            if (e.key === 'r' && !isTyping) { e.preventDefault(); return }
    ...
    }, [setIsPrivacyMode, canEdit, handleAdd, searchInputRef, selectedIds, setIsBulkDeleteOpen, setIsShortcutOpen, searchQuery, setSearchQuery, hasActiveFilters, resetAllFilters, setSelectedIds, setIsExportModalOpen])
}
