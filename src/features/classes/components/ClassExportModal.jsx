...
import { Warning, ArrowsLeftRight, ArrowsDownUp, Buildings, Calendar, CheckCircle, FileXls, FileText, FileArrowUp, GraduationCap, TextH, Spinner, GearSix, SlidersHorizontal, Tag, UserCheck, Users } from '@phosphor-icons/react'

import { Modal } from '@shared/components'

const COLUMN_DEFS = [
    { key: 'nama_kelas', label: 'Nama Kelas', icon: Buildings },
    { key: 'tingkat', label: 'Tingkat / Grade', icon: GraduationCap },
    { key: 'program', label: 'Program / Major', icon: Buildings },
    { key: 'wali_kelas', label: 'Wali Kelas', icon: UserCheck },
    { key: 'tahun_ajaran', label: 'Tahun Ajaran', icon: Calendar },
    { key: 'jumlah_siswa', label: 'Jumlah Siswa', icon: Users },
]
...
export default function ClassExportModal({
    ...
    const columnButtons = COLUMN_DEFS.map(({ key, label, icon: Icon }) => {
