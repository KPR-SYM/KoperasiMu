...
const SHORTCUTS = [
    ...
    { section: "Aksi" },
    { keys: ["N"], label: "Tambah kelas baru", icon: Plus, action: "add" },
    { keys: [MOD, "I"], label: "Import CSV / Excel", icon: Upload, action: "import" },
    { keys: [MOD, "E"], label: "Export Data", icon: Download, action: "export" },
    { keys: ["E"], label: "Edit kelas terpilih", icon: Pencil, action: "edit", needsSelection: true },
    ...
    { keys: ["⌫"], label: "Hapus terpilih", icon: Trash, action: "bulkDelete", needsSelection: true },
    { section: "Mode" },
...
const ClassesShortcutMenu = memo(function ClassesShortcutMenu({
    isOpen,
    onClose,
    onAction,
    selectedCount = 0,
    ...
    const container = getPortalContainer("portal-classes-shortcut-menu");
...
export default ClassesShortcutMenu;
