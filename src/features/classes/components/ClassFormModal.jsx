...
const ClassFormModal = memo(function ClassFormModal({
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title={selectedItem ? 'Pen Data Kelas' : 'Tambah Kelas Baru'}
            description={
            ...
            <form id="class-form-modal" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2.5 pt-2">
                        ...
                        <SealCheck className="text-[var(--color-primary)] w-3 h-3 opacity-70" />
                ...
                <div className="space-y-4 pb-4">
                    <div className="flex items-center gap-2.5 pt-2">
                        <div className="w-1 h-4 bg-[var(--color-primary)] rounded-full" />
                        <UserCheck className="text-[var(--color-primary)] w-3 h-3 opacity-70" />
