...
import { Heartbeat, MagnifyingGlass, Plus, Trash, X, Pen, Calendar, User, Clock, WarningCircle, Bed, ArrowsHorizontal, FileXls, DownloadSimple, Check, Pill, FileText, CheckCircle, Star, Printer, Sparkle, Eye, EyeSlash, Sliders } from '@phosphor-icons/react'

// Local storage keys for fallback persistence
const LS_HEALTH_LOGS = 'koperasimu_health_logs'
...
export default function HealthPage() {
    ...
    // FloppyDisk Medical Record to Supabase (With auto stock deduction and fallback)
    ...
    // FloppyDisk Medicine (Add / Pen) with Supabase persistence
    ...
    const handlePrintLogs = () => {
        ...
        const html = `
            <html>
                <head>
                    <title>Jurnal Kesehatan Poskestren Koperasi SenyumMu</title>
                    <style>
                ...
                <body>
                    ...
                    <h2>Koperasi SenyumMu - Periode Mei 2026</h2>
                    <table>
                        <thead>
                            <tr>
                                <th>Tanggal & Waktu</th>
        ...
        <DashboardLayout title={tp('title')}>
            <div className="p-4 sm:p-6 space-y-5">
                ...
                <Modal
                    ...
                    title={activeLog ? 'Pen Catatan Medis' : 'Tambah Catatan Medis'}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full h-10 px-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] text-[12px] font-bold focus:outline-none focus:border-[var(--color-primary)] cursor-pointer"
                                >
                                    <option value="tablet">DeviceTablet / Kaplet</option>
