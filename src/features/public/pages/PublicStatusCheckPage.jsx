...
export default function PublicStatusCheckPage() {
    ...
    useEffect(() => {
        document.title = 'Koperasi SenyumMu - Cek Status Kelulusan & PSB'
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            console.error('[PublicStatusCheck] MagnifyingGlass error:', err)
    ...
    const handlePaymentProofUpload = async (type, e) => {
        ...
        try {
            ...
            console.error('[PublicStatusCheck] UploadSimple error:', err)
    ...
    const renderTimeline = () => {
        ...
        return (
            <div className="bg-[var(--color-surface)] shadow-md border border-[var(--color-border)] rounded-3xl p-6 md:p-8 space-y-6">
                <h4 className="w-3 h-3 font-black uppercase tracking-widest text-[var(--color-text-muted)] opacity-60">ClockClockwise Tahap Pendaftaran</h4>
                            ...
                            <div key={st.key} className="flex-1 flex flex-col md:items-center gap-2 relative">
                                <div className="flex items-center gap-3 md:flex-col md:gap-2 text-left md:text-center">
                                    ...
                                    <div className={`w-8 h-8 rounded-2xl flex items-center justify-center font-black text-xs transition-all ${circleClass}`}>
                                        {isDone ? <CheckCircle /> : i + 1}
                                    </div>
                                    <div className="leading-tight">
                                        <p className={`w-3 h-3 font-bold uppercase tracking-wider ${isActive ? 'text-[var(--color-text)]' : 'text-[var(--color-text-muted)] opacity-70'}`}>
                                            {st.label}
                                        </p>
    ...
    // Render Stats and Congratulation Cube
            ...
            return (
                <div className="celebrate-card p-6 md:p-8 rounded-3xl bg-emerald-500/10 border border-emerald-500/20 text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="w-4 h-4 font-bold text-[var(--color-text)]">Ananda dinyatakan diterima sebagai calon santri Muhammadiyah Boarding Buildings Tanggul.</p>
                    ...
                    {!enrollment.metadata?.acceptance_confirmed ? (
                        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-5 max-w-lg mx-auto text-left space-y-4 shadow-sm">
                            <h4 className="w-3 h-3 font-black uppercase tracking-wider text-[var(--color-text)] flex items-center gap-1.5">
                            ...
                            <label className="flex items-start gap-3 cursor-pointer select-none">
                                ...
                                <span className="text-[11px] font-semibold text-[var(--color-text)] leading-relaxed">
                                    Kami selaku orang tua / wali calon santri menyatakan <strong>BERSEDIA</strong> untuk bergabung dan menyetujui seluruh tata tertib serta administrasi daftar ulang Muhammadiyah Boarding Buildings Tanggul.
                                </span>
                            </label>
                            <button
                            ...
                            >
                                {confirming ? (
                                    <><Spinner className="fa-spin" /> Memproses Konfirmasi...</>
                                ) : (
            ...
            return (
                <div className="p-6 md:p-8 rounded-3xl bg-indigo-500/10 border border-indigo-500/20 text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="w-4 h-4 font-bold text-[var(--color-text)]">Status pendaftaran Ananda saat ini memasuki tahap: <strong>Daftar Ulang</strong>.</p>
                        <p className="text-xs text-[var(--color-text-muted)] opacity-80 max-w-lg mx-auto leading-relaxed pt-1">
            ...
            return (
                <div className="p-6 md:p-8 rounded-3xl bg-amber-500/10 border border-amber-500/20 text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="w-4 h-4 font-bold text-[var(--color-text)]">Hasil Ujian Lulus, namun Kuota Gelombang ini Penuh.</p>
                        <p className="text-xs text-[var(--color-text-muted)] opacity-80 max-w-lg mx-auto leading-relaxed pt-1">
            ...
            return (
                <div className="p-6 md:p-8 rounded-3xl bg-rose-500/10 border border-rose-500/20 text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="w-4 h-4 font-bold text-[var(--color-text)]">Kami mohon maaf, pendaftaran Ananda saat ini belum dapat diterima.</p>
                        <p className="text-xs text-[var(--color-text-muted)] opacity-80 max-w-lg mx-auto leading-relaxed pt-1">
                            Terima kasih telah berpartisipasi dan mendaftar di Muhammadiyah Boarding Buildings Tanggul. Tetap semangat, semoga sukses dalam pendidikan di tempat lain!
                        </p>
                    </div>
                </div>
            )
        ...
        return (
            <div className="p-5 rounded-2xl bg-indigo-500/5 border border-indigo-500/10 flex items-start gap-4">
                ...
                <div className="space-y-0.5">
                    <h5 className="w-3 h-3 font-black uppercase tracking-wider text-[var(--color-text)]">Status Pendaftaran Aktif</h5>
        ...
        return (
            <div className="bg-[var(--color-surface)] shadow-md border border-[var(--color-border)] rounded-3xl p-6 md:p-8 space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[var(--color-border)]/40 pb-4">
                    <div>
                        <h4 className="w-4 h-4 font-black uppercase tracking-wider text-[var(--color-text)]">Informasi Pembayaran & Daftar Ulang</h4>
                    ...
                    <div className="text-right">
                        ...
                        <p className="w-5 h-5 font-black text-[var(--color-primary)] mt-0.5 tabular-nums">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 rounded-2xl bg-indigo-500/5 border border-indigo-500/10 w-3 h-3">
                    <div className="space-y-2">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <p className="w-5 h-5 font-black text-[var(--color-text)] select-all tracking-wide">7788-9999-00</p>
                        </div>
                        <div className="space-y-0.5">
                    ...
                    <div className="space-y-2 border-t sm:border-t-0 sm:border-l border-[var(--color-border)] pt-3 sm:pt-0 sm:pl-5 flex flex-col justify-center">
                        <div className="flex items-start gap-2 text-[10px] text-[var(--color-text-muted)] font-bold leading-normal">
                            <Warning className="text-amber-500 shrink-0 mt-0.5" />
                            <div className="space-y-1">
                                    ...
                                    <div className="flex items-start justify-between gap-2">
                                        <div>
                                            ...
                                            <div className="flex items-baseline gap-0.5 mt-0.5">
                                                ...
                                                <span className="w-4 h-4 font-black text-[var(--color-text)] tabular-nums">{formatPrice(p.amount)}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div className="pt-2">
                                        ...
                                        >
                                            {uploadingCategory[p.type] ? (
                                                <><Spinner className="fa-spin" /> Unggah...</>
                                            ) : (
                                                <><UploadSimple /> {proofUrl ? 'Ganti Bukti' : 'Unggah Bukti'}</>
                                            )}
                                        </button>
                                    </div>
                                )}
    ...
    return (
        <div className="min-h-screen bg-[var(--color-background)] transition-colors duration-300 pb-16">
            ...
            <header className="border-b border-[var(--color-border)] bg-[var(--color-surface)]/70 backdrop-blur-md sticky top-0 z-50 transition-colors">
                <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link to="/psb" className="h-9 px-4 rounded-xl border border-[var(--color-border)] text-[var(--color-text-muted)] hover:text-[var(--color-text)] flex items-center justify-center gap-2 transition-all bg-[var(--color-surface)] w-3 h-3 font-black uppercase tracking-wider">
                            <ArrowLeft /> Kembali ke Pendaftaran
                        </Link>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-4xl mx-auto px-4 pt-8 md:pt-12 space-y-8">
                {/* MagnifyingGlass Header Container */}
                {!enrollment && (
                    <div className="max-w-md mx-auto text-center space-y-6 pt-4">
                        ...
                        {errorMsg && (
                            <div className="p-3.5 rounded-2xl bg-rose-500/10 border border-rose-500/20 w-3 h-3 font-bold text-rose-600 dark:text-rose-400 text-left flex items-start gap-2.5">
                                <XCircle className="shrink-0 mt-0.5 w-3 h-3" />
                                <span>{errorMsg}</span>
                            </div>
                        )}
                        ...
                        <form onSubmit={handleSearch} className="bg-[var(--color-surface)] shadow-xl border border-[var(--color-border)] rounded-3xl p-6 text-left space-y-4">
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <User className="absolute left-4.5 top-3.5 w-3 h-3 text-[var(--color-text-muted)] opacity-40" />
                                    <input
                                        type="text"
                                        name="regNum"
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <Phone className="absolute left-4.5 top-3.5 w-3 h-3 text-[var(--color-text-muted)] opacity-40" />
                                    <input
                                        type="text"
                                        name="phone"
                            ...
                            >
                                {searching ? (
                                    <><Spinner className="fa-spin" /> Memeriksa...</>
                                ) : (
                                    <><MagnifyingGlass /> Cek Status Sekarang</>
                                )}
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[var(--color-surface)] shadow-md border border-[var(--color-border)] rounded-3xl p-5 md:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-0.5">
                                    <div className="flex items-center gap-2">
                                        <h3 className="w-5 h-5 font-black text-[var(--color-text)] leading-tight">{enrollment.name}</h3>
