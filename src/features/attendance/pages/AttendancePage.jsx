...
const STATUS_META = {
    H: { label: 'Hadir', color: 'text-emerald-600', cellBg: 'bg-emerald-500/15', cellBorder: 'border-emerald-500/30', textColor: '#059669', icon: UserCheck },
    S: { label: 'Sakit', color: 'text-amber-600', cellBg: 'bg-amber-500/15', cellBorder: 'border-amber-500/30', textColor: '#d97706', icon: Heartbeat },
    I: { label: 'Izin', color: 'text-blue-600', cellBg: 'bg-blue-500/15', cellBorder: 'border-blue-500/30', textColor: '#2563eb', icon: FileText },
    A: { label: 'Alpa', color: 'text-red-600', cellBg: 'bg-red-500/15', cellBorder: 'border-red-500/30', textColor: '#dc2626', icon: XCircle },
    P: { label: 'Pulang Awal', color: 'text-purple-600', cellBg: 'bg-purple-500/15', cellBorder: 'border-purple-500/30', textColor: '#7c3aed', icon: DoorOpen },
}

const STATUS_LIST = ['H', 'S', 'I', 'A', 'P']
const DOW_SHORT = ['Mg', 'Sn', 'Sl', 'Rb', 'Km', 'Jm', 'Sb']

// Lebar sticky cols (px) â€” harus konsisten antara th dan td
const W_NO = 40   // kolom #
...
// â”€â”€â”€ DayCell â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ StudentRow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const StudentRow = memo(({ student, idx, days, tahun, bulan, daysInMonth, todayDate, onCellMouseDown, onCellMouseEnter, onRowFill, onNoteClick, note, hideWeekend, focusedDay, alpaThreshold, hadirThreshold, visibleDays, onSetFocusedCell }) => {
    ...
    return (
        <tr className={`table-row-lazy ${alertAlpa ? 'bg-red-500/[0.02]' : ''}`}>
            ...
            {/* Nama â€” sticky, klik untuk row fill */}
            <td
            ...
            >
                <div className="flex items-center justify-between gap-1">
                    ...
                    {/* Note button â€” fixed width agar nama tidak shift */}
                    <div className="w-5 shrink-0">
                        ...
                        >
                            <Note className="w-2 h-2" />
                        </button>
                    </div>
                </div>
            </td>

            {/* Day cells â€” respects hideWeekend */}
...
// â”€â”€â”€ RowSkeleton â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ MassActionDropdown â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return (
        <>
            ...
            >
                ...
                Aksi Massal
                <CaretDown className={`w-2 h-2 transition-transform ${open ? 'rotate-180' : ''}`} />
            </button>
...
// â”€â”€â”€ NotePopup â€” catatan per siswa per bulan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return createPortal(
        <div ref={ref} style={{
            ...
            <div style={{ padding: '8px 12px 6px', borderBottom: '1px solid var(--color-border)', display: 'flex', alignItems: 'center', gap: 8 }}>
                <Note style={{ fontSize: 10, color: '#f59e0b' }} />
...
// â”€â”€â”€ ImportModal â€” upload CSV/Excel absensi lama â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                <div className="p-5 overflow-y-auto flex-1 space-y-4">
                    ...
                    <div className="p-3 rounded-xl bg-blue-500/5 border border-blue-500/20">
                        ...
                        <p className="text-[10px] text-[var(--color-text-muted)] leading-relaxed">
                            ...
                            Nilai: <strong>H</strong> Hadir Â· <strong>S</strong> Sakit Â· <strong>I</strong> Izin Â· <strong>A</strong> Alpa Â· <strong>P</strong> Pulang Awal.
                        </p>
                    </div>
                    {/* Drop zone */}
                    <label className="flex flex-col items-center justify-center gap-2 p-6 rounded-xl border-2 border-dashed border-[var(--color-border)] hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)]/3 transition-all cursor-pointer">
                        <UploadSimple className="text-2xl text-[var(--color-text-muted)]" />
                    ...
                    {loading && <div className="flex items-center justify-center gap-2 py-4"><Spinner className="animate-spin text-[var(--color-primary)]" /><span className="text-[11px] text-[var(--color-text-muted)]">Membaca file...</span></div>}
                        ...
                        <div className="space-y-3">
                            ...
                            {preview.unmatched.length > 0 && (
                                <div className="p-3 rounded-xl bg-amber-500/5 border border-amber-500/20">
                                    ...
                                    {preview.unmatched.slice(0, 5).map((n, i) => <p key={i} className="text-[10px] text-[var(--color-text-muted)]">Â· {n}</p>)}
...
// â”€â”€â”€ AlertThresholdModal â€” konfigurasi ambang batas alert â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                <div className="p-5 space-y-4">
                    <div>
                        <label className="block text-[10px] font-black uppercase tracking-wider text-[var(--color-text-muted)] mb-2">
                            Alpa â‰¥ <span className="text-red-600 text-[14px] ml-1">{alpa}</span> hari â†’ merah
                        </label>
                    ...
                    <div>
                        <label className="block text-[10px] font-black uppercase tracking-wider text-[var(--color-text-muted)] mb-2">
                            Kehadiran &lt; <span className="text-amber-600 text-[14px] ml-1">{hadirPct}%</span> â†’ kuning
                        </label>
...
// â”€â”€â”€ MobileCardView â€” Option B: card per siswa dengan dot grid â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function MobileCardView({ filteredStudents, dataMap, tahun, bulan, daysInMonth, todayDate, onCellClick, notesMap, onNoteClick, alpaThreshold, hadirThreshold, loadingData }) {
    // â”€â”€ Semua hooks sebelum early return (Rules of Hooks) â”€â”€
    const weekdays = useMemo(() => countWeekdays(tahun, bulan), [tahun, bulan])
            ...
            {filteredStudents.map((s, idx) => {
                ...
                return (
                    <div key={s.id} className={`rounded-2xl border bg-[var(--color-surface)] overflow-hidden transition-all ${alertAlpa ? 'border-red-300 dark:border-red-800' : 'border-[var(--color-border)]'}`}>
                        ...
                        <div className={`flex items-center justify-between px-4 py-2.5 border-b border-[var(--color-border)] ${alertAlpa ? 'bg-red-500/5' : 'bg-[var(--color-surface-alt)]/40'}`}>
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    {alertAlpa && <p className="text-[9px] font-black text-red-500 flex items-center gap-1"><Warning className="w-2 h-2" />Alpa {sum.A}Ã—</p>}
                                    {!alertAlpa && alertHadir && <p className="text-[9px] font-black text-amber-500 flex items-center gap-1"><Bell className="w-2 h-2" />Hadir {pct}%</p>}
                                </div>
                            </div>
                        ...
                        {/* Circle grid â€” 7 kolom penuh, angka & status dalam 1 tombol */}
                        <div className="px-2 pt-2 pb-1">
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 3 }}>
                                ...
                                {/* Placeholder invisible â€” isi sisa kolom baris terakhir agar mentok kanan */}
...
// â”€â”€â”€ MobileListView â€” Option C: list ringkas + bottom drawer detail â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function MobileListView({ filteredStudents, dataMap, tahun, bulan, daysInMonth, todayDate, onCellClick, notesMap, onNoteClick, alpaThreshold, hadirThreshold, loadingData }) {
    ...
    // â”€â”€ Semua hooks HARUS sebelum early return (Rules of Hooks) â”€â”€
    const handleBackdrop = useCallback((e) => {
        if (e.target === e.currentTarget) setExpandedId(null)
    }, [])

    // Last 5 weekdays â€” dihitung selalu, bukan setelah early return
    ...
    // â”€â”€ Early returns setelah semua hooks â”€â”€
    if (loadingData) return (
    ...
    return (
        <>
                        ...
                        <div key={s.id} className={`flex items-center gap-2.5 px-4 py-2.5 transition-colors ${alertAlpa ? 'bg-red-500/[0.02]' : ''}`}>
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-1">
                                    ...
                                    {hasNote && <Note className="w-2 h-2 text-amber-500 shrink-0" />}
                                </div>
                                <div className="flex items-center gap-1.5 mt-0.5">
                                    ...
                                    <span className={`text-[9px] font-black tabular-nums ${alertAlpa ? 'text-red-500' : 'text-[var(--color-text-muted)]'}`}>
                                        {alertAlpa ? `âš  Alpa ${sum.A}Ã—` : `${pct}%`}
                                    </span>
                                </div>
                            </div>

                            {/* Last 5 days â€” merged day+status */}
            ...
            {/* Bottom drawer â€” detail bulan penuh */}
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-5 pb-3 pt-1 border-b border-[var(--color-border)] shrink-0">
                            <div className="min-w-0">
                                ...
                                <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">{BULAN_NAMA[bulan]} {tahun} Â· {daysInMonth} hari</p>
                            </div>
                                ...
                                return (
                                    <>
                                        ...
                                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 6 }}>
                                            ...
                                            {/* Placeholder â€” isi sisa kolom baris terakhir */}
                                            {Array.from({ length: (7 - (daysInMonth % 7)) % 7 }).map((_, i) => (
...
// â”€â”€â”€ Haptic feedback helper â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ CommandPalette â€” âŒ˜K shortcut launcher â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    const COMMANDS = useMemo(() => [
        {
            group: 'Data',
            items: [
                { id: 'fill-hadir', label: 'Isi semua: Hadir', desc: 'Set semua hari kerja = H', icon: UserCheck, color: '#059669', action: () => onAction('fill', 'H') },
                { id: 'fill-alpa', label: 'Isi semua: Alpa', desc: 'Set semua hari kerja = A', icon: XCircle, color: '#dc2626', action: () => onAction('fill', 'A') },
                { id: 'copy-last', label: 'Copy bulan lalu', desc: `Salin data ${BULAN_NAMA[prevBulan]} ${prevTahun}`, icon: Copy, color: '#6366f1', action: () => onAction('copyLastMonth') },
                { id: 'reset', label: 'Reset semua data', desc: 'Kosongkan seluruh absensi bulan ini', icon: ArrowCounterClockwise, color: '#dc2626', action: () => onAction('reset') },
                { id: 'save', label: 'Simpan perubahan', desc: isDirty ? 'Ada perubahan belum tersimpan' : 'Sudah tersimpan', icon: FloppyDisk, color: '#059669', action: () => onAction('save'), disabled: !isDirty },
                { id: 'undo', label: 'Batalkan (ArrowCounterClockwise)', desc: 'Ctrl+Z', icon: ArrowCounterClockwise, color: '#888', action: () => onAction('undo') },
            ]
        },
        {
            group: 'Tampilan',
            items: [
                ...
                { id: 'view-list', label: 'View: List', desc: 'Tampilan ringkas + expand (mobile)', icon: List, color: '#6366f1', action: () => onAction('setMobileView', 'list') },
                { id: 'view-table', label: 'View: Tabel', desc: 'Tampilan tabel klasik', icon: Table, color: '#6366f1', action: () => onAction('setMobileView', 'table') },
            ]
        },
        {
            group: 'Info',
            items: [
                { id: 'info', label: `${studentCount} siswa Â· ${completionPct}% terisi`, desc: `${BULAN_NAMA[bulan]} ${tahun}`, icon: ChartBar, color: '#888', action: () => { }, disabled: true },
            ]
        },
        ...
        <div className="fixed inset-0 z-[200] flex flex-col items-center pt-[10vh] px-4 pb-4 bg-black/50 backdrop-blur-sm"
            ...
            <div className="w-full max-w-lg bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] shadow-2xl overflow-hidden flex flex-col max-h-[75vh]">
                ...
                <div className="flex items-center gap-3 px-4 py-3 border-b border-[var(--color-border)]">
                    <MagnifyingGlass className="text-[var(--color-text-muted)] w-3 h-3 shrink-0" />
                    <input
                        ref={inputRef}
                        type="text"
                            ...
                            {group.items.map(item => (
                                ...
                                >
                                    <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0"
                                        ...
                                        <item.icon style={{ color: item.color, fontSize: 11 }} />
                                    </div>
                ...
                <div className="px-4 py-2 border-t border-[var(--color-border)] flex items-center gap-3">
                    <span className="text-[9px] text-[var(--color-text-muted)]">
                        <kbd className="px-1 py-0.5 rounded bg-[var(--color-surface-alt)] border border-[var(--color-border)] text-[8px] font-black">â†µ</kbd> pilih
                        <span className="ml-2"><kbd className="px-1 py-0.5 rounded bg-[var(--color-surface-alt)] border border-[var(--color-border)] text-[8px] font-black">â†‘â†“</kbd> navigasi</span>
...
// â”€â”€â”€ MobileToolbarSheet â€” bottom drawer untuk overflow actions di mobile â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ ColFillPopup â€” klik angka header tanggal â†’ isi semua siswa â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div style={{ padding: '4px 0' }}>
                ...
                <button onClick={() => { onClear(); onClose() }}
                    ...
                    <span className="w-6 h-6 rounded-md flex items-center justify-center bg-[var(--color-surface-alt)] border border-[var(--color-border)]" style={{ flexShrink: 0 }}>
                        <ArrowCounterClockwise style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
                    </span>
...
// â”€â”€â”€ RowFillPopup â€” klik nama siswa â†’ isi semua hari kerjanya â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function RekapBulananPanel({ classId, tahun, bulan, studentList, dataMap }) {
    ...
    const handleSync = async () => {
        ...
        if (error) {
            ...
            addToast(`${studentList.length} siswa berhasil disinkronkan ke Raport âœ“`, 'success')
            setSyncDone(true)
            const ids = studentList.map(s => s.id)
    ...
    const handlePrint = useCallback(() => {
        ...
        win.document.write(`<!DOCTYPE html><html><head>
            <title>Rekap Absensi â€” ${BULAN_NAMA[bulan]} ${tahun}</title>
            <style>
            ...
            <h1>Rekap Absensi â€” ${BULAN_NAMA[bulan]} ${tahun}</h1>
            ...
            <table>
                <thead><tr>
                    ...
                    <th>Hadir %</th>
                    ${hasLastMonth ? `<th>Î” vs ${BULAN_NAMA[prevBulanVal]}</th>` : ''}
                </tr></thead>
                <tbody>${rows}</tbody>
            </table>
    ...
    const handleExport = async () => {
        ...
        addToast('Export Excel berhasil âœ“', 'success')
    ...
    return (
        <div>
            <div className="px-4 py-3 border-b border-[var(--color-border)]">
                ...
                {/* â”€â”€ Desktop: satu baris â”€â”€ */}
                <div className="hidden sm:flex items-center justify-between gap-3">
                    <div>
                        <p className="text-[13px] font-black text-[var(--color-text)]">Rekap â€” {BULAN_NAMA[bulan]} {tahun}</p>
                        <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">{weekdays} hari efektif Â· Seninâ€“Jumat</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <button onClick={handleExport}
                            ...
                            <FileArrowUp className="w-3 h-3" /> Export Excel
                        </button>
                        ...
                        <button onClick={handleSync} disabled={syncing}
                            ...
                            {syncing ? <Spinner className="animate-spin" /> : syncDone ? <CheckCircle /> : <CloudArrowUp />}
                ...
                {/* â”€â”€ Mobile: dua baris â”€â”€ */}
                <div className="sm:hidden space-y-2">
                    {/* Baris 1: Judul + Sync */}
                    <div className="flex items-center justify-between gap-2">
                        <div className="min-w-0">
                            <p className="text-[13px] font-black text-[var(--color-text)] leading-tight">Rekap â€” {BULAN_NAMA[bulan]} {tahun}</p>
                            <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">{weekdays} hari efektif Â· Seninâ€“Jumat</p>
                        </div>
                        <button onClick={handleSync} disabled={syncing}
                            className={`shrink-0 h-8 px-3 rounded-xl text-[10px] font-black flex items-center gap-1.5 transition-all ${syncDone
                                ? 'bg-emerald-500/10 border border-emerald-500/20 text-emerald-600'
                                : 'bg-[var(--color-primary)] hover:opacity-90 text-white shadow-sm shadow-[var(--color-primary)]/20 disabled:opacity-60'}`}>
                            {syncing ? <Spinner className="animate-spin w-3 h-3" /> : syncDone ? <CheckCircle className="w-3 h-3" /> : <CloudArrowUp className="w-3 h-3" />}
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-0.5 bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5">
                            {[
                                { key: 'a', label: 'Kompak', icon: List },
                                { key: 'c', label: 'GridFour', icon: Table },
                                { key: 'd', label: 'Heatmap', icon: GridNine },
                            ].map(v => (
                                <button key={v.key}
                        ...
                        <div className="flex items-center gap-1.5">
                            <button onClick={handleExport}
                                ...
                                <FileArrowUp className="w-3 h-3" /> Export
                            </button>
                            <button onClick={handlePrint}
                                className="h-7 px-2.5 rounded-xl border border-[var(--color-border)] text-[10px] font-black text-[var(--color-text-muted)] hover:bg-[var(--color-surface-alt)] transition-all flex items-center gap-1.5">
                                <Printer className="w-3 h-3" /> Cetak
            ...
            {summary && (
                <div className="grid grid-cols-3 gap-3 px-5 py-3 border-b border-[var(--color-border)]">
                    {[
                        ...
                        { label: 'Alpa â‰¥ 3 hari', val: summary.alpaCount, sub: 'siswa perlu perhatian', color: summary.alpaCount > 0 ? 'text-red-600' : 'text-[var(--color-text-muted)]' },
                    ].map(c => (
            ...
            {/* â•â•â•â• MOBILE VIEWS â•â•â•â• */}

            {/* â”€â”€ View A: Compact + bar â”€â”€ */}
            {rekapMobileView === 'a' && (
                                ...
                                <div className="flex items-center gap-2 mb-1.5">
                                    ...
                                    {delta !== null && delta !== 0 && (
                                        <span className={`text-[9px] font-black flex items-center gap-0.5 shrink-0 ${delta > 0 ? 'text-emerald-600' : 'text-red-500'}`}>
                                            {delta > 0 ? <TrendUp className="w-2 h-2" /> : <TrendDown className="w-2 h-2" />}
                                            {delta > 0 ? `+${delta}` : delta}
                                        </span>
                                    )}
            ...
            {/* â”€â”€ View C: Fixed columns grid â”€â”€ */}
            {rekapMobileView === 'c' && (
                            ...
                            return (
                                <div key={s.id}
                                    ...
                                    <div className="min-w-0 pr-1">
                                        ...
                                        {alertAlpa && <p className="text-[8px] font-black text-red-500 mt-0.5">Alpa {r.A}Ã—</p>}
                                    </div>
                                    {['H', 'S', 'I', 'A', 'P'].map(k => (
            ...
            {/* â”€â”€ View D: Mini heatmap (GitHub-style) â”€â”€ */}
            {rekapMobileView === 'd' && (
                <div className="sm:hidden divide-y divide-[var(--color-border)]">
                    {studentList.map((s, idx) => {
                        const r = rekapData[s.id] || {}
                        ...
                        return (
                            <div key={s.id} className={`px-4 py-2.5 ${alertAlpa ? 'bg-red-500/[0.02]' : ''}`}>
                                ...
                                {/* Heatmap dots â€” setiap dot = 1 hari kerja */}
                                <div className="pl-7">
                ...
                <table className="w-full">
                    <thead className="bg-[var(--color-surface-alt)] sticky top-0 z-10">
                        <tr>
                            ...
                            <th className="px-3 py-3 text-center"><span className="text-[9px] font-black uppercase tracking-widest text-[var(--color-text-muted)]">Î” Bulan Lalu</span></th>
                            ...
                            return (
                                <tr key={s.id} className={`transition-colors hover:bg-[var(--color-surface-alt)]/50 ${alertAlpa ? 'bg-red-500/[0.02]' : ''}`}>
                                    ...
                                    <td className="px-4 py-2.5 min-w-[160px]">
                                        ...
                                        {alertAlpa && <p className="text-[9px] font-black text-red-600 flex items-center gap-1 mt-0.5"><Warning className="w-2 h-2" />Alpa {r.A} hari</p>}
                                    </td>
                                    ...
                                    <td className="px-3 py-2.5 text-center">
                                        {(() => {
                                            const lm = lastMonthMap[s.id]
                                            if (!lm) return <span className="text-[9px] text-[var(--color-text-muted)]">â€”</span>
                                            const delta = (r.H || 0) - (lm.H || 0)
                                            return (
                                                <span className={`text-[11px] font-black flex items-center justify-center gap-1 ${delta > 0 ? 'text-emerald-600' : delta < 0 ? 'text-red-600' : 'text-[var(--color-text-muted)]'}`}>
                                                    {delta > 0 && <TrendUp className="w-3 h-3" />}
                                                    {delta < 0 && <TrendDown className="w-3 h-3" />}
                                                    {delta > 0 ? `+${delta}` : delta}
                                                </span>
                                            )
                                        })()}
                                    ...
                                    <td className="px-3 py-2.5 text-center">
                                        {rap
                                            ? synced
                                                ? <span className="inline-flex items-center gap-1 text-[9px] font-black text-emerald-600 bg-emerald-500/10 px-1.5 py-0.5 rounded-md"><CheckCircle className="w-2 h-2" /> Sinkron</span>
                                                : <span className="inline-flex items-center gap-1 text-[9px] font-black text-amber-600 bg-amber-500/10 px-1.5 py-0.5 rounded-md"><Warning className="w-2 h-2" /> Beda</span>
...
// â”€â”€â”€ ConfirmModal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div className="w-full max-w-xs bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] shadow-2xl overflow-hidden">
                <div className="flex items-start gap-3 px-5 pt-5 pb-4">
                    <div className="w-8 h-8 rounded-xl bg-amber-500/10 flex items-center justify-center shrink-0 mt-0.5">
                        <Warning className="text-amber-500 w-3 h-3" />
                    </div>
                    <div>
...
// â”€â”€â”€ TutorialModal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    const SLIDES = [
        {
            ...
            subtitle: 'Format baru â€” lebih detail, lebih mudah',
            body: (
        ...
        },
        {
            ...
            subtitle: 'Klik sel untuk ganti status â€” cycling otomatis',
            body: (
                <div className="space-y-2.5 text-[11px] text-[var(--color-text)] leading-relaxed">
                        ...
                        {[...STATUS_LIST, ''].map((s, i) => (
                            <div key={i} className="flex items-center gap-1 shrink-0">
                                {s
                                    ...
                                    : <span className="w-8 h-8 rounded-lg flex items-center justify-center text-[11px] font-black border border-[var(--color-border)] bg-[var(--color-surface-alt)] text-[var(--color-text-muted)]">â€”</span>
                                }
                                {i < 5 && <CaretRight className="text-[var(--color-text-muted)] opacity-25 w-2 h-2 shrink-0" />}
                            </div>
                        ))}
                    </div>
                    {/* Legend: huruf â†’ label */}
                    <div className="grid grid-cols-3 gap-1.5">
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-alt)]">
                            <span className="text-[11px] font-black text-[var(--color-text-muted)]">â€”</span>
                            <span className="text-[9px] font-bold text-[var(--color-text-muted)]">=</span>
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-start gap-2">
                                <span className="w-5 h-5 rounded-full bg-red-400/20 border border-red-400/30 flex items-center justify-center shrink-0 mt-0.5">
                                    <CalendarBlank className="text-red-400 w-2 h-2" />
                                </span>
                                <span className="text-[10px] text-[var(--color-text-muted)]">Kolom <b>Sabtu &amp; Minggu</b> â€” angka merah &amp; redup, tetap bisa diisi jika sekolah masuk</span>
                            </div>
                            <div className="flex items-start gap-2">
                                <span className="w-5 h-5 rounded-lg bg-[var(--color-surface-alt)] border border-[var(--color-border)] flex items-center justify-center shrink-0 mt-0.5">
                                    <XCircle className="text-[var(--color-text-muted)]/30 w-2 h-2" />
                                </span>
                                <span className="text-[10px] text-[var(--color-text-muted)]">Kolom <b>tanggal tidak valid</b> (misal Feb 30â€“31) â€” disabled otomatis, tidak bisa diklik</span>
                            </div>
                        </div>
                    </div>
                </div>
            ),
            tips: 'Klik lagi saat sudah Pulang Awal (P) akan balik ke kosong. Siklus: kosong â†’ H â†’ S â†’ I â†’ A â†’ P â†’ kosong.',
        },
        {
            icon: ListChecks,
            ...
            body: (
                <div className="space-y-3 text-[11px] text-[var(--color-text)] leading-relaxed">
                    <p className="text-[var(--color-text-muted)]">Tombol <strong>Aksi Massal</strong> di toolbar memungkinkan kamu mengisi semua hari kerja (Seninâ€“Jumat) untuk semua siswa sekaligus.</p>
                    ...
                    <div className="p-2.5 rounded-xl border border-red-500/20 bg-red-500/5 flex items-center gap-2">
                        <ArrowCounterClockwise className="text-red-500 w-3 h-3 shrink-0" />
                        <p className="text-[10px] text-red-600"><strong>Reset Semua</strong> â€” hapus seluruh isian bulan ini dan mulai dari kosong.</p>
                    </div>
                </div>
            ),
            tips: 'Aksi massal berguna untuk awal bulan â€” isi semua Hadir dulu, lalu koreksi siswa yang tidak hadir satu per satu.',
        },
        {
            icon: FloppyDisk,
                    ...
                    <div className="p-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-alt)]">
                        <p className="font-black mb-1 flex items-center gap-1.5">
                            <span className="w-5 h-5 rounded-lg bg-sky-500/15 border border-sky-500/20 flex items-center justify-center shrink-0">
                                <FloppyDisk className="text-sky-500 w-2 h-2" />
                            </span>
                            Simpan ke HardDrives
                        </p>
                    ...
                    <div className="p-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-alt)]">
                        <p className="font-black mb-1 flex items-center gap-1.5">
                            <span className="w-5 h-5 rounded-lg bg-indigo-500/15 border border-indigo-500/20 flex items-center justify-center shrink-0">
                                <List className="text-indigo-500 w-2 h-2" />
                            </span>
                            Auto-Draft Lokal
                        </p>
            ...
            body: (
                <div className="space-y-3 text-[11px] text-[var(--color-text)] leading-relaxed">
                    ...
                    <div className="p-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-alt)]">
                        <p className="font-black mb-1 text-violet-600 flex items-center gap-1.5">
                            <span className="w-5 h-5 rounded-lg bg-violet-500/15 border border-violet-500/20 flex items-center justify-center shrink-0">
                                <ArrowCounterClockwise className="text-violet-500 w-2 h-2" />
                            </span>
                            Sync ke Raport
                        </p>
                    ...
                    <div className="p-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-alt)]">
                        <p className="font-black mb-1 flex items-center gap-1.5">
                            <span className="w-5 h-5 rounded-lg bg-emerald-500/15 border border-emerald-500/20 flex items-center justify-center shrink-0">
                                <FileArrowUp className="text-emerald-500 w-2 h-2" />
                            </span>
                            Export Excel
                        </p>
                        <p className="text-[var(--color-text-muted)]">DownloadSimple data absensi lengkap (per hari + rekap) dalam format .xlsx. Kolom tanggal menampilkan kode H/S/I/A/P.</p>
                    </div>
                    <div className="flex items-center gap-2 p-2 rounded-xl border border-red-500/20 bg-red-500/5">
                        ...
                        <p className="text-[10px] text-red-600">Siswa alpa <strong>â‰¥ 3 hari</strong> ditandai merah di rekap sebagai peringatan perhatian khusus.</p>
                    </div>
                </div>
            ),
            ...
            >
                ...
                <div className="px-6 pb-2">
                    <div className="p-3 rounded-xl bg-emerald-500/8 border border-emerald-500/20 flex items-start gap-2">
                        <Lightbulb className="text-emerald-500 w-3 h-3 mt-0.5 shrink-0" />
                ...
                <div className="flex items-center gap-3 px-6 py-4">
                    <button onClick={() => setStep(v => Math.max(0, v - 1))} disabled={isFirst}
                        ...
                        <CaretLeft className="w-3 h-3" /> Sebelumnya
                    </button>
                    ...
                    {isLast ? (
                        ...
                        <button onClick={() => setStep(v => Math.min(SLIDES.length - 1, v + 1))}
                            className="h-9 px-5 rounded-xl bg-emerald-500 text-white text-[10px] font-black hover:bg-emerald-600 transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-500/20">
                            Berikutnya <CaretRight className="w-3 h-3" />
                        </button>
                    )}
                </div>
            </div>
...
// â”€â”€â”€ Guru Attendance Tab â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// (embedded directly â€” uses AttendancePage's imports and constants)
...
// â”€â”€ Potongan gaji per menit terlambat â€” sesuaikan kebijakan pesantren â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// Parse Fingerspot XLS â€” returns array of { name, date, scan1, scan2, scan3, scan4 }
...
// â”€â”€â”€ StatusBadge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ AttendanceSettingsModal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div className="w-full max-w-3xl bg-[var(--color-surface)] rounded-[32px] border border-[var(--color-border)] shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-[var(--color-border)]">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-2xl bg-[var(--color-primary)]/10 flex items-center justify-center">
                            <GearSix className="text-[var(--color-primary)] w-5 h-5" />
                        </div>
                        <div>
                ...
                <div className="p-6 overflow-y-auto flex-1 bg-[var(--color-surface-alt)]/30">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[var(--color-surface)] rounded-[24px] border border-[var(--color-border)] px-5 py-1 shadow-sm">
                                <InputRow label="Jam Masuk" sub="Waktu kedatangan guru agar tidak dihitung terlambat.">
                                    <div className="relative group">
                                        ...
                                        <Clock className="absolute right-3 top-1/2 -translate-y-1/2 w-3 h-3 text-[var(--color-text-muted)] group-focus-within:text-[var(--color-primary)] transition-colors pointer-events-none" />
                                    </div>
                                </InputRow>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-2 px-1">
                                    <Money className="w-3 h-3 text-amber-500" />
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-2 px-1">
                                    <TrendUp className="w-3 h-3 text-purple-500" />
                    ...
                    <div className="mt-8 flex items-start gap-4 p-4 rounded-[20px] bg-blue-500/5 border border-blue-500/10">
                        <div className="w-8 h-8 rounded-xl bg-blue-500/10 flex items-center justify-center shrink-0">
                            <Warning className="text-blue-500 w-4 h-4" />
                        </div>
                        <div className="min-w-0">
                ...
                <div className="px-5 py-3 border-t border-[var(--color-border)] flex gap-2 justify-end bg-[var(--color-surface)]">
                    ...
                    <button onClick={handleSave} disabled={saving}
                        ...
                        {saving ? <Spinner className="animate-spin" /> : <FloppyDisk />}
                        Simpan Pengaturan
                    </button>
                </div>
            </div>
...
// â”€â”€â”€ HistoryDrawer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function HistoryDrawer({ teacher, onClose, settings = DEFAULT_ATTENDANCE_SETTINGS }) {
    ...
    // â”€â”€ Kalkulasi jam kerja & lembur â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div className="w-full max-w-lg bg-[var(--color-surface)] rounded-3xl border border-[var(--color-border)] shadow-2xl flex flex-col max-h-[88vh] overflow-hidden">
                ...
                <div className="sticky top-0 bg-[var(--color-surface)] border-b border-[var(--color-border)] px-5 py-4 flex items-center gap-3 z-10 rounded-t-3xl shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-[var(--color-text-muted)]">{teacher.type ? teacher.type.charAt(0).toUpperCase() + teacher.type.slice(1) : 'Guru'} Â· Riwayat Kehadiran</p>
                    </div>
                ...
                <div className="p-5 space-y-4 flex-1 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {[
                            { label: 'Total Jam', val: fmtDuration(stats.totalWorkMin), color: 'text-blue-600', bg: 'bg-blue-500/8', border: 'border-blue-500/20', icon: ClockCounterClockwise },
                            { label: 'Rata-rata', val: fmtDuration(stats.avgWorkMin), color: 'text-indigo-600', bg: 'bg-indigo-500/8', border: 'border-indigo-500/20', icon: ChartBar },
                            { label: 'Total Lembur', val: settings.lembur_enabled !== false ? fmtDuration(stats.totalLemburMin) : 'â€”', color: stats.totalLemburMin > 0 && settings.lembur_enabled !== false ? 'text-purple-600' : 'text-[var(--color-text-muted)]', bg: stats.totalLemburMin > 0 && settings.lembur_enabled !== false ? 'bg-purple-500/8' : 'bg-[var(--color-surface-alt)]', border: stats.totalLemburMin > 0 && settings.lembur_enabled !== false ? 'border-purple-500/20' : 'border-[var(--color-border)]', icon: TrendUp },
                        ].map(s => (
                            <div key={s.label} className={`rounded-2xl border ${s.border} ${s.bg} p-3 text-center`}>
                    ...
                    {stats.totalLemburMin > 0 && settings.lembur_enabled !== false && (
                        <div className="px-3 py-2 rounded-xl bg-purple-500/5 border border-purple-500/15 flex items-center gap-2">
                            <TrendUp className="text-purple-500 w-3 h-3 shrink-0" />
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-1.5 flex-wrap">
                                                <p className="text-[10px] text-[var(--color-text-muted)] tabular-nums">
                                                    {fmtTime(r.scan_in)} â†’ {fmtTime(r.scan_out)}
                                                </p>
                                                {workMin !== null && (
                                                ...
                                                {r.early_leave_minutes > 0 && (
                                                    <span className="text-[9px] text-purple-600 font-bold bg-purple-500/8 px-1.5 py-0.5 rounded-md border border-purple-500/20">
                                                        pulang âˆ’{r.early_leave_minutes}m
                                                    </span>
                                                )}
                                            </div>
...
// â”€â”€â”€ ImportModal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function FingerspotImportModal({ teachers, onClose, onImported }) {
    ...
    const [nameMap, setNameMap] = useState({}) // fingerspotName â†’ teacherId
    ...
    // â”€â”€ Auto-match by similarity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    useEffect(() => {
        ...
        const score = (fpName, teacherName) => {
            ...
            for (const fpWords of variants(fpName)) {
                ...
                // e.g. "Rasyidi" â†’ "Ali Rasyidi", "rifandi" â†’ "Muhammad Rifandi"
                if (fpWords.length === 1) {
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            addToast(`${previewRows.length} record absensi berhasil diimpor âœ“`, 'success')
            onImported()
            onClose()
        } catch (e) {
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-2xl max-h-[90vh] bg-[var(--color-surface)] rounded-3xl border border-[var(--color-border)] shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="px-6 py-4 border-b border-[var(--color-border)] flex items-center justify-between shrink-0">
                    <div>
                        ...
                        <p className="text-[10px] text-[var(--color-text-muted)]">
                            {step === 1 && 'UploadSimple file XLS export dari Fingerspot Personnel'}
                            {step === 2 && `${fingerspotNames.length} nama ditemukan Â· ${unmapped.length} belum dipetakan`}
                ...
                <div className="px-6 py-3 border-b border-[var(--color-border)] flex items-center gap-2 shrink-0">
                    {['UploadSimple', 'Mapping Nama', 'Preview'].map((s, i) => (
                        <div key={s} className="flex items-center gap-2">
                            ...
                            {i < 2 && <ArrowRight className="w-2 h-2 text-[var(--color-border)]" />}
                        </div>
                    ))}
                </div>
                    ...
                    {step === 1 && (
                        ...
                        >
                            <input ref={fileRef} type="file" accept=".xls,.xlsx" className="hidden"
                                onChange={e => handleFile(e.target.files[0])} />
                            {parsing ? (
                                <Spinner className="animate-spin text-3xl text-[var(--color-primary)] mb-4" />
                            ) : (
                                <UploadSimple className="text-3xl text-[var(--color-text-muted)] mb-4" />
                            )}
                            ...
                            {fingerspotNames.map(fn => {
                                ...
                                return (
                                    <div key={fn} className="glass rounded-2xl border border-[var(--color-border)] p-3 flex items-center gap-3">
                                        ...
                                        {mapped ? <Link className={`w-3 h-3 shrink-0 text-emerald-500`} /> : <LinkBreak className={`w-3 h-3 shrink-0 text-[var(--color-text-muted)]`} />}
                                        <select
                                            value={nameMap[fn] || ''}
                                        ...
                                        >
                                            <option value="">â€” Abaikan â€”</option>
                                            {teachers.map(t => (
                            ...
                            <div className="grid grid-cols-3 gap-2 mb-4">
                                {Object.entries(
                                    ...
                                    <div key={status} className="glass rounded-2xl border border-[var(--color-border)] p-2 text-center">
                                        <p className="w-5 h-5 font-black text-[var(--color-text)]">{count}</p>
                ...
                <div className="px-6 py-4 border-t border-[var(--color-border)] flex items-center justify-between shrink-0">
                    <button onClick={() => step > 1 ? setStep(s => s - 1) : onClose()}
                        ...
                        {step === 1 ? 'Batal' : 'â† Kembali'}
                    </button>
                    {step === 1 && (
                        <p className="text-[9px] text-[var(--color-text-muted)]">
                            Export dari Fingerspot Personnel â†’ Report â†’ Excel
                        </p>
                    )}
                    {step === 2 && (
                        <button onClick={() => setStep(3)}
                            ...
                            Preview â†’ ({rawRows.length} baris)
                        </button>
                    )}
                    {step === 3 && (
                        <button onClick={handleImport} disabled={importing || !previewRows.length}
                            ...
                            {importing
                                ? <><Spinner className="animate-spin w-3 h-3" /> {progress.done}/{progress.total}</>
                                : <><FileArrowDown className="w-3 h-3" /> Import {previewRows.length} Record</>}
                        </button>
                    )}
                </div>
            </div>
...
// â”€â”€â”€ Main GuruAttendanceTab â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function GuruTab() {
    ...
    // UsersThree attendance by teacher for monthly/weekly view
    ...
    // Daily view â€” group by teacher for selected date
    ...
    const periodLabel = useMemo(() => {
        ...
        if (viewMode === 'mingguan') {
            ...
            const mon = new Date(d); mon.setDate(d.getDate() - (dow === 0 ? 6 : dow - 1))
            const sun = new Date(mon); sun.setDate(mon.getDate() + 6)
            return `${mon.getDate()} â€“ ${sun.getDate()} ${BULAN_NAMA[sun.getMonth() + 1]} ${sun.getFullYear()}`
        }
    ...
    return (
        <div className="space-y-4">
            ...
            {/* â”€â”€ Header controls â€” mirror pola Siswa: view tabs + period nav di luar card â”€â”€ */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                {/* View mode tabs */}
                <div className="flex items-center bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5">
                    {[
                        { key: 'harian', label: 'Harian', icon: CalendarBlank },
                        { key: 'mingguan', label: 'Mingguan', icon: CalendarBlank },
                        { key: 'bulanan', label: 'Bulanan', icon: ChartBar },
                    ].map(v => (
            ...
            {/* â”€â”€ Main card â€” sama strukturnya dengan Siswa: card + toolbar di dalam â”€â”€ */}
            <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden">
                ...
                {loading ? (
                        ...
                        <div className="divide-y divide-[var(--color-border)]">
                            {filtered.map(t => (
                                <div key={t.id} className="grid grid-cols-1 md:grid-cols-[1fr_120px_90px_90px_110px_80px] gap-3 px-5 py-3 items-center hover:bg-[var(--color-surface-alt)]/40 transition-colors">
                                    ...
                                    <div>{t.record ? <StatusBadge status={t.record.status} /> : <span className="text-[9px] text-[var(--color-text-muted)]">â€”</span>}</div>
                                    <button onClick={() => setHistoryTeacher(t)}
                                        ...
                                        <ClockCounterClockwise className="w-2 h-2" /> Riwayat
                                    </button>
                                </div>
                            ))}
                        </div>
                                    ...
                                    return (
                                        <tr key={t.id} className="hover:bg-[var(--color-surface-alt)]/30 transition-colors">
                                            ...
                                            {monthDays.map(({ d, isWeekend }) => {
                                                ...
                                                const letter = status ? (GURU_LETTER_MAP[status] || status.charAt(0).toUpperCase()) : (isLibur ? 'L' : isWeekend ? 'Â·' : '')
                                            ...
                                            <td style={{ textAlign: 'center', borderLeft: '1px solid var(--color-border)' }}>
                                                <span className="text-[10px] font-black text-purple-600 tabular-nums">{t.stats.totalLemburMin > 0 ? fmtDurationG(t.stats.totalLemburMin) : 'â€”'}</span>
                                            </td>
                                            <td style={{ textAlign: 'center', borderLeft: '1px solid var(--color-border)' }}>
                                                <button onClick={() => setHistoryTeacher(t)}
                    ...
                    /* Weekly view â€” same as monthly but filtered to 7 days */
                    <div className="divide-y divide-[var(--color-border)]">
                        {filtered.map(t => (
...
export default function AttendancePage() {
    ...
    // ArrowCounterClockwise/ArrowClockwise history
    ...
    // â”€â”€ Feature 1: Copy bulan lalu â”€â”€
    const [copyingLastMonth, setCopyingLastMonth] = useState(false)
    // â”€â”€ Feature 2: Keyboard nav state â”€â”€
    ...
    // Ref to always-current filteredStudents â€” keeps handleCellMouseDown stable (no deps)
    const filteredStudentsRef = useRef([])
    // â”€â”€ Feature 6: Catatan per siswa â”€â”€
    const [notesMap, setNotesMap] = useState({}) // { studentId: string }
    const [noteTarget, setNoteTarget] = useState(null) // { student, x, y }
    // â”€â”€ Feature 7: Import CSV/Excel â”€â”€
    const [showImport, setShowImport] = useState(false)
    // â”€â”€ Feature 10: Alert threshold â”€â”€
    ...
    // â”€â”€ Mobile view mode: 'table' | 'card' | 'list' â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const [mobileView, setMobileView] = useState(() => {
        try { return localStorage.getItem('absensi_mobile_view') || 'table' } catch { return 'table' }
    })
    // â”€â”€ TerminalWindow Palette â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // Feature 3: visibleDays â€” filtered by hideWeekend
    ...
    // Always-current ref â€” keeps handleCellMouseDown zero-dependency (stable)
    ...
    useEffect(() => {
        ...
        document.title = cls ? `Absensi ${cls.name} Â· ${BULAN_NAMA[bulan]} ${tahun} | Koperasi SenyumMu` : 'Absensi Bulanan | Koperasi SenyumMu'
        return () => { document.title = 'Koperasi SenyumMu' }
    }, [classId, classList, bulan, tahun])

    useEffect(() => {
        const on = () => { setIsOnline(true); addToast('Koneksi kembali', 'success') }
        const off = () => { setIsOnline(false); addToast('Offline â€” perubahan disimpan lokal', 'warning') }
    ...
    const handleCellMouseDown = useCallback((sid, day) => {
        // Update focused cell â€” find rowIdx from filteredStudents at call time
        setFocusedCell(prev => {
    ...
    // Commit history snapshot only once on mouseup â€” not on every cell during drag
    useEffect(() => {
        const stop = () => {
    ...
    const handleSave = useCallback(async () => {
        ...
        if (!isOnline) {
            setSaving(false); addToast('Offline â€” data tersimpan lokal, sync saat online', 'warning'); return
        }
        const upserts = studentList.map(s => ({
    ...
    // â”€â”€ Feature 1: Copy bulan lalu â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const handleCopyLastMonth = useCallback(async () => {
        ...
        addToast(`Data ${BULAN_NAMA[prevBulanVal]} ${prevTahunVal} disalin âœ“`, 'success')
    }, [classId, bulan, tahun, studentList, copyingLastMonth, pushHistory, addToast, profile])

    // â”€â”€ Feature 5: Scroll ke hari ini â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Feature 2: Keyboard nav â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    useEffect(() => {
        const h = (e) => {
    ...
    // â”€â”€ Feature 6: Notes persistence â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    useEffect(() => {
        if (!classId) return
        try {
    ...
    // â”€â”€ Feature 7: Import CSV/Excel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const handleImport = useCallback((matched) => {
        ...
        setIsDirty(true)
        addToast(`${matched.length} siswa diimport âœ“`, 'success')
    ...
    // â”€â”€ Feature 10: FloppyDisk alert threshold â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const handleSaveThreshold = useCallback((val) => {
        setAlertThreshold(val)
        try { localStorage.setItem('absensi_alert_threshold', JSON.stringify(val)) } catch { }
        addToast('Ambang batas alert disimpan âœ“', 'success')
        logAudit({ action: 'UPDATE', source: 'MASTER', tableName: 'preferences', newData: { type: 'alert_threshold', ...val } })
    }, [addToast])

    // â”€â”€ Fix 3: Stable callbacks â€” not recreated per-student per-render â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ TerminalWindow Palette actions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return (
        <DashboardLayout>
            <div className="p-4 md:p-6 max-w-[1800px] mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-[var(--color-text-muted)] text-[11px] mt-0.5 font-medium opacity-70">
                            ...
                            <span className="hidden sm:inline">Klik sel untuk ganti status Â· Tahan &amp; geser untuk isi banyak Â· Klik nama/tanggal untuk isi cepat</span>
                        </p>
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                        {/* âŒ˜K + Tutorial â€” hanya tampil di tab Siswa */}
                        {mainTab === 'siswa' && (
                            <>
                                <button
                                    ...
                                    title="TerminalWindow Palette (Ctrl+K)"
                                >
                        ...
                        {/* Online indicator â€” hanya tampil kalau offline */}
                        {!isOnline && (
                ...
                {/* â”€â”€ Main Tab: Siswa / Guru â”€â”€ */}
                <div className="flex items-center bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5 w-fit mb-5">
                    {[
                        { key: 'siswa', label: 'Absensi Siswa', icon: PresentationChart },
                        { key: 'guru', label: 'Absensi Guru', icon: Users },
                    ].map(t => (
                ...
                {mainTab === 'siswa' && <>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            {loadingClass ? (
                                ...
                                <div className="relative flex-1 sm:flex-none">
                                    <PresentationChart className="absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 text-[var(--color-text-muted)] pointer-events-none" />
                            ...
                            {/* Tabs â€” muncul di kanan kelas pada mobile */}
                            <div className="flex items-center bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5 sm:hidden ml-auto">
                                {[
                                    { key: 'input', icon: CalendarBlank },
                                    { key: 'rekap', icon: ChartBar },
                                ].map(t => (
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="hidden sm:flex items-center bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5 ml-auto">
                                {[
                                    { key: 'input', label: 'Input', icon: CalendarBlank },
                                    { key: 'rekap', label: 'Rekap', icon: ChartBar },
                                ].map(t => (
                                    <button key={t.key} onClick={() => setActiveTab(t.key)}
                    ...
                    {draftAvail && !isDirty && (
                        <div className="flex items-center gap-3 px-4 py-3 rounded-xl border border-amber-500/20 bg-amber-500/5 mb-4">
                            <Warning className="text-amber-500 shrink-0" />
                    ...
                    <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden shadow-sm">
                        ...
                        {/* â•â• TAB INPUT â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
                        {activeTab === 'input' && (
                            <>
                                {/* â”€â”€ Toolbar â”€â”€ */}
                                <div className="px-3 md:px-4 py-3 border-b border-[var(--color-border)] flex flex-col gap-3">
                                    ...
                                    <div className="flex items-center justify-between w-full overflow-x-auto no-scrollbar pb-1 sm:pb-0 gap-4">
                                        ...
                                        {/* Left: Data & ClockCounterClockwise Actions */}
                                        <div className="flex items-center gap-3 shrink-0">
                                            {/* UsersThree: Data Actions */}
                                            <div className="flex items-center bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5 shadow-sm">
                                                ...
                                                <button onClick={handleCopyLastMonth} disabled={copyingLastMonth || loadingData}
                                                    ...
                                                    {copyingLastMonth ? <Spinner className="animate-spin w-3 h-3" /> : <Copy className="w-3 h-3" />}
                                            ...
                                            {/* UsersThree: ClockCounterClockwise & NavigationArrow */}
                                            <div className="flex items-center bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5 shadow-sm">
                                        ...
                                        {/* Right: View GearSix & Legend */}
                                        <div className="flex items-center gap-3 shrink-0 ml-auto">
                                            {/* UsersThree: View GearSix (Desktop) */}
                                            <div className="hidden sm:flex items-center bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5 shadow-sm">
                                                <button onClick={() => setHideWeekend(v => !v)}
                                                    ...
                                                    {hideWeekend ? <EyeSlash className="w-3 h-3" /> : <Eye className="w-3 h-3" />}
                                                ...
                                                <select value={filterMode} onChange={e => setFilterMode(e.target.value)}
                                                    ...
                                                    <option value="alpa">Alpa â‰¥ {alertThreshold.alpa}</option>
                                    ...
                                    {/* Row 2: MagnifyingGlass & Progress */}
                                    <div className="flex items-center gap-4 w-full">
                                        ...
                                        <div className="sm:hidden flex items-center gap-2 shrink-0">
                                            ...
                                            <div className="flex items-center gap-0.5 bg-[var(--color-surface-alt)] rounded-xl border border-[var(--color-border)] p-0.5">
                                                {[
                                                    { key: 'table', icon: Table, label: 'Tabel' },
                                                    { key: 'card', icon: GridNine, label: 'Card' },
                                        ...
                                        {/* MagnifyingGlass Input â€” Flex-1 to stretch & fill the remaining space without max-width */}
                                        <div className="relative group flex-1 w-full">
                                            <MagnifyingGlass className="absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 text-[var(--color-text-muted)] group-focus-within:text-indigo-500 transition-colors pointer-events-none" />
                                ...
                                <MobileToolbarSheet open={showMobileSheet} onClose={() => setShowMobileSheet(false)}>
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            {hideWeekend ? <EyeSlash className="w-3 h-3 w-4" /> : <Eye className="w-3 h-3 w-4" />}
                                    ...
                                    <div className="px-4 py-3 rounded-xl border border-[var(--color-border)]">
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            {[
                                                ...
                                                { val: 'alpa', label: `Alpa â‰¥ ${alertThreshold.alpa} hari`, sub: 'Siswa perlu perhatian' },
                                                ...
                                                <button key={opt.val}
                                                    ...
                                                    {filterMode === opt.val && <Check className="text-amber-600 w-3 h-3" />}
                                                </button>
                                            ))}
                                        </div>
                                    </div>
                                    ...
                                    >
                                        <Bell className="w-3 h-3 w-4 text-amber-500" />
                                        <div className="text-left">
                                            <p className="text-[12px] font-black">Konfigurasi Alert</p>
                                            <p className="text-[10px] text-[var(--color-text-muted)]">Alpa â‰¥ {alertThreshold.alpa} hari Â· Hadir &lt; {alertThreshold.hadirPct}%</p>
                                        </div>
                                        <CaretRight className="ml-auto w-3 h-3 text-[var(--color-text-muted)]" />
                                    </button>
                                </MobileToolbarSheet>
                                ...
                                {/* â”€â”€ Desktop always table + Mobile table view â”€â”€ */}
                                <div className={`${mobileView !== 'table' ? 'hidden sm:block' : ''}`}>
                                    {/* Landscape table */}
                                    <div className="overflow-x-auto">
                                        <table style={{ borderCollapse: 'collapse', minWidth: 'max-content', width: '100%' }}>
                                            <thead>
                                                {/* Row 1: angka tanggal â€” # dan Nama span 2 baris */}
                                                <tr style={{ backgroundColor: 'var(--color-surface-alt)' }}>
                                                    {/* No header â€” rowSpan 2 */}
                                                    <th
                                                        rowSpan={2}
                                                        style={{
                                                            position: 'sticky', left: 0, zIndex: 6,
                                                    ...
                                                    {dayMeta.filter(dm => !(hideWeekend && dm.weekend) && !dm.invalid).map(({ d, weekend, dow }) => (
                                                        <th key={d}
                                                            ...
                                                            title={`Klik untuk isi semua siswa â€” tgl ${d}`}
                                                    ...
                                                    {/* Summary headers â€” STICKY RIGHT */}
                                                    {STATUS_LIST.map((s, i) => {
                                                        const rightOffset = 40 + (STATUS_LIST.length - 1 - i) * 28;
                                                        return (
                                                            <th key={s}
                                                                        ...
                                                                        <EmptyState 
                                                                            ...
                                                                            action={
                                                                                <button onClick={() => setFilterMode('all')}
                                                                                    ...
                                                                                    <ArrowCounterClockwise className="w-3 h-3" /> Reset filter
                                                                                </button>
                                                                            }
                                                                        />
                                                                    ) : completionPct === 0 && studentList.length > 0 ? (
                                                                        // Empty: no data yet this month â€” engaging CTA
                                                                        <EmptyState 
                                                                            icon={CalendarBlank}
                                                                            ...
                                                                            action={
                                                                                <div className="flex items-center gap-2 flex-wrap justify-center">
                                                                                    <button
                                                                                        ...
                                                                                        {copyingLastMonth ? <Spinner className="animate-spin" /> : <Copy />}
                        ...
                        {/* â•â• TAB REKAP â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
                        {activeTab === 'rekap' && (
                            <RekapBulananPanel
                    ...
                    {/* Confirm Modal â€” ganti kelas/bulan saat ada perubahan */}
                    {confirmModal && (
                        <ConfirmModal
            ...
            {/* â”€â”€ Global modals â€” aktif di kedua tab siswa & guru â”€â”€ */}

            {/* Tutorial modal */}
            {showTutorial && <TutorialModal onClose={() => setShowTutorial(false)} />}

            {/* TerminalWindow Palette */}
            <CommandPalette
