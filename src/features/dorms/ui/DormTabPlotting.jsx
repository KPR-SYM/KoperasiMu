...
import { MagnifyingGlass, X, Sliders, GridFour, Table, CheckCircle, User, UserMinus, ArrowsHorizontal, Bed, WarningCircle, Users, ArrowCounterClockwise } from '@phosphor-icons/react'
            ...
            <div className="glass rounded-[1.5rem] mb-4 border border-[var(--color-border)] overflow-hidden">
                ...
                <div className="flex items-center gap-1.5 p-2 xs:gap-2 xs:p-2.5 lg:p-3">
                    ...
                    <div className="hidden lg:flex flex-initial items-center gap-2 overflow-x-auto scrollbar-hide py-0.5 min-w-0 h-full">
                        ...
                        {/* UsersThree 1: Status Plotting */}
                        <div className="flex items-center gap-1.5 shrink-0">
                            {[
                                { id: 'All', label: t('dorms.plotting.all'), icon: Users, activeCls: 'bg-[var(--color-primary)] border-[var(--color-primary)]' },
                                { id: 'Assigned', label: t('dorms.plotting.assigned'), icon: CheckCircle, activeCls: 'bg-emerald-500 border-emerald-500' },
                                { id: 'Unassigned', label: t('dorms.plotting.unassigned'), icon: WarningCircle, activeCls: 'bg-amber-500 border-amber-500' },
                            ].map((s) => {
