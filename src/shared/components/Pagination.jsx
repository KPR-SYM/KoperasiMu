    ...
    return (
        <div className="p-3 border-t border-[var(--color-border)] bg-[var(--color-surface-alt)]/20 rounded-b-xl">
            ...
            <div className="flex md:hidden flex-col gap-3.5">
                ...
                <div className="flex items-center justify-between w-full bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[1.25rem] shadow-sm p-1">
                    <div className="flex items-center gap-1">
                        <button
                            disabled={page <= 1}
                            onClick={() => setPage(1)}
                            className="w-8 h-8 flex items-center justify-center rounded-lg text-[var(--color-text-muted)] hover:bg-[var(--color-surface-alt)] hover:text-[var(--color-primary)] transition-all disabled:opacity-20 disabled:hover:bg-transparent disabled:active:scale-100 active:scale-90"
                        >
                        ...
                        {getPageItems(page, totalPages).map((it, idx) => (
                            it === '...' ? (
                                ...
                                <button key={`pg-${it}`} onClick={() => setPage(it)}
                                    className={`h-8 min-w-[32px] px-2 rounded-lg font-black text-[9px] transition-all active:scale-95
                                    ${it === page
