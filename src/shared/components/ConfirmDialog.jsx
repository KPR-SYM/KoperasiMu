            ...
            footer={
                <div className="flex items-center w-full gap-2">
                    <button
                        ...
                        onClick={onClose}
                        disabled={submitting}
                        className="h-9 px-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-surface-alt)] text-[10px] font-black uppercase tracking-widest transition-all shrink-0 disabled:opacity-50"
                    >
                        {cancelText}
                    </button>
                    ...
                    >
                        {submitting ? (
                            ...
                            <ConfirmIcon className="w-3 h-3 opacity-70" />
                        ) : null}
                        {confirmText}
                    </button>
                </div>
